...
""");
    ...
    final ExecCommand C1 = new ExecCommand("ls -la /tmp/aaaa.v");                                                       // Execute Verilog commands
    say("AAAA1", C1);
    final ExecCommand C2 = new ExecCommand("iverilog -V");                                                              // Execute Verilog commands
    say("AAAA2", C2);
    final ExecCommand C3 = new ExecCommand("iverilog -v -I/tmp/includes/ -g2012 -o aaaa /tmp/aaaa.v");                  // Execute Verilog commands
    say("AAAA3", C3);
    final ExecCommand C4 = new ExecCommand("ls -la aaaa");                                                                     // Execute Verilog commands
    say("AAAA4", C4);
