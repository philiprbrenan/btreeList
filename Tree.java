   ...
   {final Tree t = new Tree(new Build().maxLeafSize(4).maxBranchSize(3).numberOfNodes(4).immediate(Ex));
    if (true)
     ...
     {t.new ForCount(t.new Int(1), t.new Int(7))
      ...
      t.new I() {void action() {say("  static String tree32 = \""+ t.byteMemory.save()+"\";");}};
      stop();
     }
