...
""");
  ...
  static void oldTests()                                                                                                // Tests thought to be in good shape
   {if (rtg( 1)) test_branch();
    ...
    if (rtg(11)) test_stepDown();
    if (rtg(12)) test_knownInsert();
   }
